...
class MyCylinderBody extends CGFobject 
{
    ...
    initBuffers() 
    {
        ...
        var basetopDif = this.baseRadius - this.topRadius;
        var normalX = this.height / Math.sqrt(basetopDif ** 2 + this.height ** 2);
        var normalY = basetopDif / Math.sqrt(basetopDif ** 2 + this.height ** 2);
